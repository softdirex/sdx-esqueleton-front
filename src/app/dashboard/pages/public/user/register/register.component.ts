...
export class RegisterComponent implements OnInit {
  privacyPolicyPath: string =
    Commons.PATH_TERMS + '/' + Commons.TERM_CODES[0].code;
  termConditionsPath: string =
    Commons.PATH_TERMS + '/' + Commons.TERM_CODES[1].code;
  // Step validator
  currentStep?: number;
  ...
  ngOnInit() {
    ...
    this.fDocumentData = new UntypedFormGroup({
      docType: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.document_data != null
          ? this.personalDataSession.document_data[0].type
          : '',
        [Validators.required]
      ),
      docValue: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.document_data != null
          ? this.personalDataSession.document_data[0].value
          : '',
        [Validators.required, Validators.pattern(environment.documentDataRegex)]
      ),
      docCountry: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.document_data != null
          ? this.personalDataSession.document_data[0].country
          : '',
    ...
    this.fPersonalData = new UntypedFormGroup({
      name: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.first_name != null
      ...
      lastName: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.last_name != null
      ...
      email: new UntypedFormControl(this.getContactDataFromSession('MAIL'), [
        Validators.required,
        Validators.email,
      ]),
      phone: new UntypedFormControl(this.getContactDataFromSession('PHONE'), [
        Validators.required,
      ...
      gender: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.sex != null
          ? this.personalDataSession.sex + ''
          : '',
        [Validators.required]
      ),
      birthday: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.birthday != null
          ? new Date(this.personalDataSession.birthday)
          : '',
        [Validators.required]
      ),
      address: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.address != null
          ? this.personalDataSession.address
          : '',
        [
          Validators.required,
          Validators.pattern(environment.addressRegex),
          Validators.maxLength(90),
          Validators.minLength(2),
        ]
      ),
      city: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.city != null
          ? this.personalDataSession.city
          : '',
        [
          Validators.required,
          Validators.pattern(environment.namesRegex),
      ...
      country: new UntypedFormControl(
        this.personalDataSession != undefined &&
        this.personalDataSession.country != null
          ? this.personalDataSession.country
          : '',
        [
          Validators.required,
      ...
      tcCheck: new UntypedFormControl(false, [
        Validators.required,
        Validators.requiredTrue,
      ]),
      ppCheck: new UntypedFormControl(false, [
        Validators.required,
        Validators.requiredTrue,
      ]),
    });
    ...
    this.fCustomer = new UntypedFormGroup({
      cusEmail: new UntypedFormControl('', [
        Validators.required,
        Validators.email,
      ]),
      cusPwd: new UntypedFormControl('', [
        Validators.required,
        Validators.pattern(environment.pwdRegex),
      ]),
      cusPwd2: new UntypedFormControl('', [
        Validators.required,
        Validators.pattern(environment.pwdRegex),
      ]),
      cusTcCheck: new UntypedFormControl('', [
        Validators.required,
        Validators.requiredTrue,
      ]),
      cusPpCheck: new UntypedFormControl('', [
        Validators.required,
        Validators.requiredTrue,
      ]),
    });
  ...
  ngAfterContentChecked(): void {
    this.emailConfirmationMessage = this.langService.translate(
      'register.confirm-email-question'
    );
  }
  ...
  get docType() {
    return this.fDocumentData.get('docType')!;
  }
  get docValue() {
    return this.fDocumentData.get('docValue')!;
  }
  get docCountry() {
    return this.fDocumentData.get('docCountry')!;
  }
  /* --END-- STEP_DOCUMENT_DATA Get Controls */
  /* -BEGIN- STEP_REGISTER Get Controls */
  get name() {
    return this.fPersonalData.get('name')!;
  }
  get lastName() {
    return this.fPersonalData.get('lastName')!;
  }
  get email() {
    return this.fPersonalData.get('email')!;
  }
  get phone() {
    return this.fPersonalData.get('phone')!;
  }
  get gender() {
    return this.fPersonalData.get('gender')!;
  }
  get birthday() {
    return this.fPersonalData.get('birthday') as UntypedFormControl;
  }
  get address() {
    return this.fPersonalData.get('address')!;
  }
  get city() {
    return this.fPersonalData.get('city')!;
  }
  get country() {
    return this.fPersonalData.get('country')!;
  }
  get pwd() {
    return this.fPersonalData.get('pwd')!;
  }
  get pwd2() {
    return this.fPersonalData.get('pwd2')!;
  }
  get tcCheck() {
    return this.fPersonalData.get('tcCheck')!;
  }
  get ppCheck() {
    return this.fPersonalData.get('ppCheck')!;
  }
  /* --END-- STEP_REGISTER Get Controls */
  /* -BEGIN- STEP_CUSTOMER Get Controls */
  get cusEmail() {
    return this.fCustomer.get('cusEmail')!;
  }
  get cusPwd() {
    return this.fCustomer.get('cusPwd')!;
  }
  get cusPwd2() {
    return this.fCustomer.get('cusPwd2')!;
  }
  get cusTcCheck() {
    return this.fCustomer.get('cusTcCheck')!;
  }
  get cusPpCheck() {
    return this.fCustomer.get('cusPpCheck')!;
  }
  /* -BEGIN- STEP_CUSTOMER Get Controls */
  ...
  private _filter(name: string): Country[] {
    ...
    return this.optionsCountries.filter((option) =>
  ...
  validCountry(value1: AbstractControl): ValidatorFn {
    return (control: AbstractControl): { [key: string]: any } | null =>
      this.optionsCountries.filter((option) => option.name === value1.value)
        .length == 1
        ? null
        : { validCountry: control.value };
  }

  onKeyValidatorCountry1() {
    this.docCountry.setValidators([
      this.validCountry(this.docCountry),
      Validators.required,
    ]);
  }
  ...
  validGender(value1: AbstractControl): ValidatorFn {
    return (control: AbstractControl): { [key: string]: any } | null =>
      this.genderTypes.filter((option) => option.value === value1.value)
        .length == 1
        ? null
        : { validGender: control.value };
  }

  sameValue(value1: AbstractControl): ValidatorFn {
    return (control: AbstractControl): { [key: string]: any } | null =>
      control.value === value1.value ? null : { notSame: control.value };
  }
  ...
  toStep2() {
    this.recaptchaV3Service
      .execute('esqueleton_create_personaldata')
      .subscribe((token: string) => {
        ...
        if (this.personalDataSession != undefined) {
          ...
          sessionStorage.setItem(
            'register',
            JSON.stringify(this.personalDataSession)
          );
        }
  ...
  openConfirmModal() {
    const message = this.emailConfirmationMessage?.replace(
      'MAIL_VALUE',
  ...
  createCustomerWithPersonalData() {
    this.recaptchaV3Service
      ...
      .subscribe((token: string) => {
        ...
        customer.personal_data.birthday = this.formatBirthdayDate(
          this.birthday.value
        );
        this.loading = true;
        this.customersService.registerCustomer(customer).subscribe({
          next: (v) => {
            this.loading = false;
            if (v != null) {
              this.succesfullStep();
          ...
          error: (e) => {
            this.loading = false;
            this.mapServiceValidationResponse(
              e.error != null && e.error != undefined ? e.error.detail : 'ERROR'
            );
          },
          complete: () => {},
        });
  ...
  formatBirthdayDate(arg: any): string | null {
    if (Commons.validField(arg)) {
      ...
      let day = arg.day + '';
      return (
        arg.year + '-' + month.padStart(2, '0') + '-' + day.padStart(2, '0')
      );
    }
    return null;
  }
  ...
  private mapServiceValidationResponse(detail: any) {
    ...
    switch (detail) {
      case 'Invalid country name':
        this.openModal(
          'validations.invalid-country',
          'validations.invalid-country-msg',
          Commons.ICON_WARNING
        );
        break;
      case 'The email entered is already in use':
        this.openModal(
          'validations.email-used',
  ...
  createCustomer() {
    this.recaptchaV3Service
      .execute('esqueleton_create_customer')
      .subscribe((token: string) => {
        this.reCAPTCHAToken = token;
        const customer: CustomerRequest = {
          lang: this.langService.getLangActive(),
