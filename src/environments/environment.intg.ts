...
export const environment = {
  ...
  production: false,
  appVersion: '1.0.0',
  localeKey: '2wR14ikRE9BadFkpfRb6',
  appName: 'APP_NAME',
  ...
  productBackendEndpoint: 'https://api-easypay-intg.softdirex.com/v1',
  coreFrontendEndpoint: 'https://escritorio-intg.softdirex.com/',
  ...
  sessionTimeMins: 10,
  recaptcha: {
    siteKey: '6LcLKvEkAAAAAH_CqrEtTpJy3vqzM9Cd9WTm9yrS',
  },
};
